...
const addMovement = function() {
  ...
  sections.forEach((section, index) => {
    ...
    if (distanceToSection > -600) {
      ...
      if (dataBackground) {
        bodyTag.classList.add("has-background");
      } else {
        bodyTag.classList.remove("has-background");
      }

      // bodyTag.classList.remove('section-section1');
      // bodyTag.classList.remove('section-section2');
      // bodyTag.classList.remove('section-section3');
      // bodyTag.classList.remove('section-section4');
      // bodyTag.classList.remove('section-section5');
      // bodyTag.classList.remove('section-footer');
      // bodyTag.classList.add('section-' + section.id);
    }
  });
};
