var animation = bodymovin.loadAnimation({
  ...
  path: "https://stigbratvold.github.io/antidiffer/AntiDiffer_Shape_1.json", // Required
...
var animation = bodymovin.loadAnimation({
  ...
  path: "https://stigbratvold.github.io/antidiffer/AntiDiffer_Shape_2.json", // Required
  renderer: "svg", // Required: svg/canvas/html
  loop: true, // Optional
  autoplay: true, // Optional
...
var animation = bodymovin.loadAnimation({
  ...
  path: "https://stigbratvold.github.io/antidiffer/AntiDiffer_Shape_3.json", // Required
  renderer: "svg", // Required: svg/canvas/html
  loop: true, // Optional
  autoplay: true, // Optional
